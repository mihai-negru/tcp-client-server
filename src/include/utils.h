...
typedef enum err_s {
    ...
    CLIENTS_VEC_CLIENT_NOT_FOUND,
    CLIENTS_VEC_COUND_NOT_ADD_A_TOPIC,
    CLIENTS_VEC_COUND_NOT_FIND_TOPIC,
    CLIENTS_VEC_INDEX_OUT_OF_BOUND
} err_t;
